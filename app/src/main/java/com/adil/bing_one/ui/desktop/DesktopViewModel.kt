    ...
    fun setCount(lifecycleScope: LifecycleCoroutineScope) {
        try {
            lifecycleScope.launch(Dispatchers.IO) {
                val list: List<String> = Methods.getWordsFromUrl(root, name, selectedCount.value!!)
    ...
    fun getClient(): WebViewClient {
        return object : WebViewClient() {
            ...
            override fun onReceivedHttpError(
                ...
                Methods.showError(view, "Status Code : ${errorResponse?.statusCode} , Message : $errorResponse ", "getClient", name)
                changePageLoadState()
